...
public:
    ...
    // ==========================================================================================
    void r2_getLastNPoses(std::vector<std::vector<double>>& poses, int numberPoses, ORB_SLAM3::PoseFileHandler& json_file_handler,  bool TUM_VI);
    void r2_getAllPoses(std::vector<std::vector<double>>& poses, bool TUM_VI); 
